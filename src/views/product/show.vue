...
<!--                  <div>-->
<!--                    <div class="single-item"> <img src="http://localhost:8876/storage/fileImg/Qt2hC7YX4VN1bISGhIjv8i0KEZoZ0CqKwKp60ezh.jpg" alt="">-->
<!--                      <div class="ptag"> <span class="one">-20% </span> </div> <a href="#0"-->
<!--                                                                                  class="love"> <i class="flaticon-like"></i> </a>-->
<!--                    </div>-->
<!--                  </div>-->
<!--                  <div>-->
<!--                    <div class="single-item"> <img src="http://localhost:8876/storage/fileImg/mx7bFiBLKGmdsjuQe2XX9dKZZS4sXziRnNUe7thy.jpg" alt="">-->
<!--                      <div class="ptag"> <span class="one">-20% </span> </div> <a href="#0"-->
<!--                                                                                  class="love"> <i class="flaticon-like"></i> </a>-->
<!--                    </div>-->
<!--                  </div>-->
<!--                  <div>-->
<!--                    <div class="single-item"> <img src="http://localhost:8876/storage/fileImg/MUkUfLFfHx9KHYBmP8qDmgEFdJoZjBCT2EmY5Bvn.jpg" alt="">-->
<!--                      <div class="ptag"> <span class="one">-20% </span> </div> <a href="#0"-->
<!--                                                                                  class="love"> <i class="flaticon-like"></i> </a>-->
<!--                    </div>-->
<!--                  </div>-->
                ...
                <div class="navholder">
                  <div v-for="productImage in product.product_images" class="product-slicknav single-product-one-nav slider-nav">
                      <div>
...
<!--                        src="http://localhost:8876/storage/fileImg/Qt2hC7YX4VN1bISGhIjv8i0KEZoZ0CqKwKp60ezh.jpg" alt=""> </span>-->
<!--                    </div>-->
<!--                    <div> <span class="single-item"> <img-->
<!--                        src="http://localhost:8876/storage/fileImg/mx7bFiBLKGmdsjuQe2XX9dKZZS4sXziRnNUe7thy.jpg" alt=""> </span>-->
<!--                    </div>-->
<!--                    <div> <span class="single-item"> <img-->
<!--                        src="http://localhost:8876/storage/fileImg/MUkUfLFfHx9KHYBmP8qDmgEFdJoZjBCT2EmY5Bvn.jpg" alt=""> </span>-->
<!--                    </div>-->
                  </div>
                </div>
              </div>
              ...
              <div class="shop-details-top-right ">
                <div v-if="product" class="shop-details-top-right-content-box">
                  ...
                  <div class="shop-details-top-price-box">
                    <h3>{{ product.price }}.00 <del>{{ product.price_old }}.00</del></h3>
                    <p>(+15% Vat Included)</p>
                  </div>
                  ...
                  <div class="shop-details-top-color-sky-box">
                    ...
                    <ul class="varients">
                      <li v-for="groupProduct in product.group_products">
<!--                        <a href="#0" class="shop-details-top-color-sky-img" data-src="@/assets/images/shop/products-img1.jpg">-->
